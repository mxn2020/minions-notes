...
- `@minions-notes/sdk` (npm package)
- `minions-notes` (PyPI package)
- `@minions-notes/cli` (npm package)
- The minions-notes web playground
- The minions-notes documentation site
